...
for i in range(100):
    ...
    gae = gf.ml.GAE(adata, layers=[20,20], lr=0.01, device=device, alpha=5, beta=5)#, exponent=2, distance_scale=10)
    ...
    #adata.write(f'{datadir}/grafiti/osmfish_grafiti_{i+1}_cl_v.h5ad')
