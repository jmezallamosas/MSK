...
for filename in os.listdir(f'{datadir}/raw'):
    ...
    if os.path.isfile(file_path):
        ...
        adata.write(f'{datadir}/grafiti/{filename[8:11]}_grafiti_lodcl_{gae.encoder_layers[0]}_{gae.encoder_layers[1]}_{gae.lr}_{gae.alpha}_{gae.beta}_{gae.gamma}.h5ad')
