...
for filename in os.listdir(f'{datadir}/raw'):
    ...
    if os.path.isfile(file_path):
        ...
        for i in range(100):
            ...
            gae = gf.ml.GAE(adata, layers=[50,50], lr=0.0001, device=device, alpha=5, beta=5)#, exponent=2, distance_scale=10)
        ...
        ari_dic[filename[:6]] = list_ari
        
        #adata.write(f'{datadir}/grafiti/'+filename[:6]+'_grafiti_v3_distribution.h5ad')

with open(f'{datadir}/grafiti/ari_grafiti_cl_v2_distribution_s.pkl', 'wb') as f:
